...
export default function NotFound() {
  return (
    <div className="flex flex-col items-center justify-center h-full space-y-4 p-8 text-center">
      <div className="bg-white p-6 rounded-full border border-slate-200 mb-4">
        <Construction className="w-16 h-16 text-blue-500" />
      </div>
      <h1 className="text-3xl font-bold text-slate-900 tracking-tight">Module Under Construction</h1>
      <p className="text-slate-9000 max-w-md">
      ...
      <Link 
        href="/"
        className="mt-8 px-6 py-3 bg-blue-600 hover:bg-blue-700 text-slate-900 font-medium rounded-lg transition-colors"
      >
