  ...
  return (
    <div className="p-8 max-w-7xl mx-auto space-y-8">
      <div>
        ...
        <p className="text-slate-400 mt-1">Live from Zoho CRM: Identifies deals losing momentum based on activity and date rules.</p>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        {staleDeals.length === 0 && (
          <div className="col-span-2 text-center py-12 bg-slate-900/50 rounded-xl border border-slate-800 border-dashed text-slate-400">
    ...
    <div className="bg-slate-900 border border-slate-800 rounded-xl p-6 shadow-sm flex flex-col justify-between">
      <div>
        <div className="flex justify-between items-start mb-4">
          <div>
            ...
            <p className="text-slate-400 text-sm mt-1">{formatCurrency(opp.expectedRevenue)} • {opp.stage}</p>
          </div>
        ...
        <div className="space-y-3 mt-6">
          ...
          <div className="flex items-start gap-3 text-sm text-slate-300">
            <CalendarX2 className="w-4 h-4 text-slate-500 mt-0.5" />
      ...
      <div className="mt-6 pt-4 border-t border-slate-800 flex gap-3">
        <a 
          ...
          className="flex-1 text-center px-4 py-2 bg-slate-800 hover:bg-slate-700 text-white text-sm font-medium rounded-lg transition-colors"
        >
          View in Zoho
        </a>
      </div>
